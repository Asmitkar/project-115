...
from_dir = r"C:\Users\USER\Desktop\Coding\C113 Capstone"              # Add the path of you "Downloads" folder.
to_dir = r"C:\Users\USER\Desktop\Coding\C113 Capstone\files" #Create "Document_Files" folder in your Desktop and update the path accordingly.
